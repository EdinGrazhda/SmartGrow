            ...
            <div class="table-responsive">
                <table class="table">
                    ...
                    <tbody>
                        ...
                        $result = $conn->query("SELECT categoryID, name, rate FROM category");
                        ...
                        if ($result->num_rows > 0) {
                            while ($row = $result->fetch_assoc()) {
                                ...
                                echo "<td>" . $row["rate"] . "</td>";
                                echo "<td>";
                                echo "<a href='update_category.php?id=" . $row["categoryID"] . "' class='btn-action btn-edit'><i class='fas fa-edit'></i> Edit</a>";
                                echo "<a href='delete_category.php?id=" . $row["categoryID"] . "' class='btn-action btn-delete' onclick=\"return confirm('Are you sure you want to delete this category?')\"><i class='fas fa-trash-alt'></i> Delete</a>";
                                echo "</td>";
                                echo "</tr>";
                            }
                        } else {
